...
async def _handle_failure(rid: str, req: dict, result: dict, retry_after: dict = None):
    ...
    # UI submission can have succeeded even if its tab closed or timed out.
    # Require review instead of submitting a duplicate paid generation.
    if 'ui_video:' in error_lower:
